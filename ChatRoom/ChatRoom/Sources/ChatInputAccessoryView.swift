...
public class InputAccessoryView: UIView {
    ...
    init(titleView: InputAccessoryTitleViewProtocol,
...
@resultBuilder
struct InputAccessoryBuilder {
    static func buildBlock(_ components: InputAccessoryView...) -> InputAccessoryViewGroup {
